# ReguSim Frontend - Chinese Text Translation Inventory

## Overview
Complete inventory of Chinese text found in the ReguSim frontend application that requires translation to English.
...
- `<meta name="description" content="ReguSim - 社交媒体舆论模拟系统" />` (ReguSim - Social Media Opinion Simulation System)
- `<title>ReguSim - 预测万物</title>` (ReguSim - Predict Everything)

...
.actions-tooltip::before {
  ...
  border-bottom: 6px solid var(--bg-surface);
}
...
.platform-status.twitter .platform-icon { color: var(--accent); }
.platform-status.reddit .platform-icon { color: var(--amber); }
...
.breakdown-item.twitter { color: var(--accent); }
.breakdown-item.reddit { color: var(--amber); }
...
.timeline-item.reddit .marker-dot { background: var(--amber); }
.timeline-item.twitter .timeline-marker { border-color: var(--accent); }
.timeline-item.reddit .timeline-marker { border-color: var(--amber); }
...
.badge-post { background: var(--bg-elevated); color: var(--text-primary); border-color: var(--border); }
.badge-comment { background: var(--bg-elevated); color: var(--text-secondary); border-color: var(--border); }
.badge-action { background: transparent; color: var(--text-secondary); border: 1px solid var(--border); }
.badge-meta { background: transparent; color: var(--text-muted); border: 1px dashed var(--border); }
...
.log-content::-webkit-scrollbar-thumb { background: rgba(148,163,184,0.2); border-radius: 2px; }

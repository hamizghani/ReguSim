    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Create new simulation instance and fetch regulatory stakeholder parameter template
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Using document context, organize entities and relationships from the regulatory knowledge graph, initialize stakeholder agents, and assign them realistic behaviors and perspectives based on their institutional roles
          </p>
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">Current Related Topics Count for Regulation</span>
            </div>
          </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Generate Stakeholder Simulation Configuration</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            LLM configures simulation parameters based on regulatory requirements: time progression, stakeholder activity patterns, response frequency, and policy event triggers
          </p>
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">ReguSim Automatically plan and infer reality <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> hours，Each round represents reality <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes time elapsed</span>
              </div>
...
.step-card.active {
  border-color: #2F7F7A;
  box-shadow: 0 4px 12px rgba(47, 127, 122, 0.08);
}
...
.badge.processing { background: #2F7F7A; color: #FFF; }
.badge.pending { background: #F5F5F5; color: #999; }
.badge.accent { background: #E3F2FD; color: #1E3A5F; }
...
.timeline-hour.active {
  background: linear-gradient(180deg, #1E3A5F, #818CF8);
}
...
.mini-bar {
  height: 4px;
  background: linear-gradient(90deg, #1E3A5F, #2F7F7A);
  border-radius: 2px;
  min-width: 4px;
  max-width: 40px;
}
...
.special-icon {
  filter: drop-shadow(0 2px 4px rgba(47, 127, 122, 0.2));

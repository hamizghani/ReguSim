        ...
        <div v-if="reportOutline" class="report-content-wrapper">
          ...
          <div class="report-header-block">
            <div class="report-meta">
              <span class="report-tag">RIA Report</span>
...
.right-panel {
  ...
  --wf-divider: rgba(148, 163, 184, 0.08);

  --wf-active-bg: var(--accent-bg);
  --wf-active-border: var(--border-accent);
  --wf-active-dot: var(--accent);
  --wf-active-text: var(--accent);

  --wf-done-bg: rgba(16, 185, 129, 0.05);
  --wf-done-border: rgba(16, 185, 129, 0.15);
  --wf-done-dot: var(--emerald);

    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM analyzes regulatory documents and simulation requirements, extracts key entities (regulators, institutions, policies), and generates the ontology structure
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, chunk regulatory documents and build knowledge graphs in Neo4j, extracting stakeholder entities, policy relationships, and regulatory context
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Regulatory graph build is complete. Proceed to set up the stakeholder simulation environment</p>
          <button 
            class="action-btn" 
...
.badge.accent { background: #2F7F7A; color: #FFF; }

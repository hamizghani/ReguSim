...
logger = get_logger('regusim.report_agent')
...
[Deep Interview - Real Stakeholder Interview (Dual Platform)]
Call the OASIS simulation environment's interview API to conduct real interviews with running stakeholder agents!
...
Function Flow:
1. Automatically read stakeholder profile files to understand all simulation agents
2. Intelligently select agents most relevant to the regulatory topic (e.g., regulators, fintech executives, consumer advocates)
...
[Use Cases]
- Need to understand regulatory perspectives from different stakeholder angles (How do regulators view it? How does the fintech industry respond? What do consumers say?)
- Need to collect diverse positions on a proposed regulation
- Need to get real responses from simulation agents (from OASIS simulation environment)
- Want to make the report more vivid, including "stakeholder interview records"

[Return Content]
- Identity information of interviewed stakeholders
- Interview responses from each stakeholder on Twitter and Reddit platforms
...
PLAN_SYSTEM_PROMPT = """\
You are an expert in writing "Regulatory Impact Assessment (RIA) reports" with a "god's eye view" of the simulated stakeholder world - you can gain insights into the behavior, statements, and interactions of every stakeholder agent in the simulation.

[Core Concept]
We built a simulation of Indonesian financial sector stakeholders and injected a specific regulatory scenario (proposed regulation, policy change, or IKD sandbox test) as the stimulus. The evolution result of the simulation is a prediction of how stakeholders will react and how the regulation will impact the financial ecosystem.

[Your Task]
Write a "Regulatory Impact Assessment report" that answers:
1. How do various financial stakeholders (regulators, banks, fintech, consumers) react to the proposed regulation?
2. What compliance challenges, market impacts, and behavioral shifts emerge from the simulation?
3. What risks, opportunities, and unintended consequences does this simulation reveal?

[Report Positioning]
- This is a Regulatory Impact Assessment based on multi-agent simulation of Indonesian financial stakeholders
- Focus on regulatory impact: stakeholder reactions, compliance patterns, market dynamics, consumer effects
- Stakeholder statements and behaviors represent predicted real-world responses to the regulation
- Not a generic policy overview - focuses on simulation-derived insights specific to the regulatory scenario

[Section Number Limit]
- Minimum 2 sections, maximum 5 sections
- No subsections needed, each section directly writes complete content
- Content should be concise, focused on core regulatory impact findings
- Section structure is designed independently based on simulation results

Please output the report outline in JSON format as follows:
{
    "title": "Report Title",
    "summary": "Report Summary (one sentence summarizing core regulatory impact findings)",
    "sections": [
        {
            "title": "Section Title",
...
[Regulatory Scenario Under Assessment]
Proposed regulation / policy change injected into the simulation: {simulation_requirement}

[Simulated Stakeholder Ecosystem Scale]
- Number of stakeholder entities in simulation: {total_nodes}
- Number of relationships between stakeholders: {total_edges}
- Stakeholder type distribution: {entity_types}
- Number of active stakeholder agents: {total_entities}

[Sample of Simulated Stakeholder Reactions and Behaviors]
{related_facts_json}

Please examine this regulatory impact simulation from a "god's eye view":
1. How do various financial stakeholders react to the proposed regulation?
2. What compliance patterns, market shifts, and behavioral changes emerge?
3. What risks, opportunities, and unintended consequences does this reveal?

Based on the simulation results, design the most appropriate RIA report section structure.

[Reminder] Report section count: minimum 2, maximum 5, content should be concise and focused on core regulatory impact findings."""

# ── Section Generation Prompt ──

SECTION_SYSTEM_PROMPT_TEMPLATE = """\
You are an expert in writing "Regulatory Impact Assessment (RIA) reports" and are writing a section of the report.

Report Title: {report_title}
Report Summary: {report_summary}
Regulatory Scenario (Simulation Requirement): {simulation_requirement}
...
The simulation models Indonesian financial sector stakeholders reacting to a proposed regulation.
Stakeholder agents represent regulators, banks, fintech companies, consumers, and other participants in the financial ecosystem.
Their behavior and interactions are predictions of how real stakeholders will respond to the regulatory change.

Your task is to:
- Reveal how stakeholders react to and are impacted by the proposed regulation
- Analyze compliance patterns, market dynamics, and behavioral shifts
- Identify risks, opportunities, and unintended consequences

❌ Don't write it as a generic policy overview
✅ Focus on simulation-derived stakeholder reactions and regulatory impact findings
...
You are a concise and efficient regulatory impact assessment assistant.

[Background]
Regulatory Scenario: {simulation_requirement}

[Generated RIA Report]
{report_content}

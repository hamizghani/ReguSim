...
logger = get_logger('regusim.api.simulation')
    ...
    Request (JSON):
        {
            ...
            "graph_id": "regusim_xxxx",    // Optional, if not provided, get from project
...
def generate_profiles():
    ...
    Request (JSON):
        {
            "graph_id": "regusim_xxxx",     // Required
